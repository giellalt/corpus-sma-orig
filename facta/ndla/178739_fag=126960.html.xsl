...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://ndla.no/nn/node/178739?fag=126960'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Filme-ållermaehteme'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Marion'"/>
    <xsl:variable name="author1_ln" select="'Federl'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Anne Ely'"/>
    <xsl:variable name="author2_ln" select="'Thorenfeldt'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Per'"/>
    <xsl:variable name="author3_ln" select="'Hotvedt'"/>
