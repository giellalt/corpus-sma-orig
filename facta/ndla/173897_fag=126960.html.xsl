...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://ndla.no/nn/node/173897?fag=126960'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Boelhke jïh scena'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Tone Elisabeth'"/>
    <xsl:variable name="author1_ln" select="'Grundvig'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author4_fn" select="'Helen Katrin Blind '"/>
    <xsl:variable name="author4_ln" select="'Brandsfjell'"/>
    <xsl:variable name="author4_gender" select="'F'"/>
    <xsl:variable name="author4_nat" select="'NO'"/>
    <xsl:variable name="author4_born" select="'1961'"/>
