...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://ndla.no/nn/node/178744?fag=126960'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gaajh tjarke histovrije-tæjmoe Gaupeste'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Kjeld-Willy'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Marion'"/>
    <xsl:variable name="author2_ln" select="'Federl'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Anne Ely'"/>
    <xsl:variable name="author3_ln" select="'Thorenfeldt'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author4_fn" select="'Ellen Bull'"/>
    <xsl:variable name="author4_ln" select="'Jonassen'"/>
    <xsl:variable name="author4_gender" select="'f'"/>
    <xsl:variable name="author4_nat" select="'NO'"/>
    <xsl:variable name="author4_born" select="'1958'"/>

    <!--
        Information of the fourth author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author5_fn" select="'Liv Karin'"/>
    <xsl:variable name="author5_ln" select="'Joma'"/>
