...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://ndla.no/nn/node/173057?fag=126960'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Maereles agumeenth jïh veanhtoeh'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Ellen Bull'"/>
    <xsl:variable name="author2_ln" select="'Jonassen'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Liv Karin'"/>
    <xsl:variable name="author3_ln" select="'Joma'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author4_fn" select="'Ajlin Jonassen'"/>
    <xsl:variable name="author4_ln" select="'Kråik'"/>
    <xsl:variable name="author4_gender" select="'f'"/>
    <xsl:variable name="author4_nat" select="'None'"/>
    <xsl:variable name="author4_born" select="'None'"/>
