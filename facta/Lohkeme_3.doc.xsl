...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Lohkeme_3.doc'"/>
  <xsl:variable name="title" select="'Saemesth amma - gåalmede gärja'"/>
  ...
  <xsl:variable name="author2_ln" select="'Åsta Vangberg'"/>
