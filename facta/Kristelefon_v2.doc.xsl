...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Kristelefon_v2.doc'"/>
  <xsl:variable name="title" select="'Telefonjour f�r samer i kris'"/>
  <xsl:variable name="author1_fn" select="'Katarina'"/>
  <xsl:variable name="author1_ln" select="'Hällgren'"/>
  ...
  <xsl:variable name="author2_fn" select="'David'"/>
  <xsl:variable name="author2_ln" select="'Jonasson'"/>
  <xsl:variable name="author2_gender" select="''"/>
  <xsl:variable name="author2_born" select="''"/>
  <xsl:variable name="author2_nat" select="''"/>
  <xsl:variable name="author3_fn" select="'Lena'"/>
  <xsl:variable name="author3_ln" select="'Kuoljok Lind'"/>
  <xsl:variable name="author3_gender" select="''"/>
  <xsl:variable name="author3_born" select="''"/>
  <xsl:variable name="author3_nat" select="''"/>
  <xsl:variable name="author4_fn" select="'David'"/>
  <xsl:variable name="author4_ln" select="'Jonasson'"/>
  <xsl:variable name="author4_gender" select="''"/>
  <xsl:variable name="author4_born" select="''"/>
  <xsl:variable name="author4_nat" select="''"/>
  <xsl:variable name="translated_from" select="'swe'"/>
  <xsl:variable name="publisher" select="'Katarina Hällgren'"/>
  <xsl:variable name="publChannel" select="''"/>
  <xsl:variable name="year" select="'2007'"/>
  <xsl:variable name="ISBN" select="''"/>
  <xsl:variable name="ISSN" select="''"/>
  <xsl:variable name="place" select="'Samefolket'"/>
  <xsl:variable name="genre" select="''"/>
  <xsl:variable name="collection" select="''"/>
  <xsl:variable name="translator_fn" select="'David'"/>
  <xsl:variable name="translator_ln" select="'Jonasson'"/>
  <xsl:variable name="translator_gender" select="'unknown'"/>
  <xsl:variable name="translator_born" select="''"/>
  <xsl:variable name="translator_nat" select="''"/>
  <!-- select license type: free, standard or other -->
  <xsl:variable name="license_type" select="''"/>
  <xsl:variable name="sub_name" select="'David Jonasson'"/>
  <xsl:variable name="sub_email" select="'david.jonasson@samediggi.no'"/>
