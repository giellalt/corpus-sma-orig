...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'lohkeme.doc'"/>
  <xsl:variable name="title" select="'Saemesth amma - mubpie gärja'"/>
  <xsl:variable name="author1_fn" select="'Helen'"/>
  <xsl:variable name="author1_ln" select="'Blind Brandsfjell'"/>
