...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Sydsamisk__2_.pdf'"/>
  <xsl:variable name="title" select="'Om sametinget'"/>
  <xsl:variable name="author1_fn" select="'Sametinget'"/>
  ...
  <xsl:variable name="translator_ln" select="'Israelsson (most likely)'"/>
