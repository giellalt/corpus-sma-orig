...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Inbjudan_till_ungdomar_ungdomsorg_sydsamiska__2_.pdf'"/>
  <xsl:variable name="title" select="'Inbjudan till ungdomskonferens'"/>
  <xsl:variable name="author1_fn" select="'Saemiedigkie'"/>
