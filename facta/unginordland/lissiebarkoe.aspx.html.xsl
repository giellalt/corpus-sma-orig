...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra/aarjelsaemien-giele/lissiebarkoe.aspx'"/>
	...
	<parallel_text xml:lang="sme" location="liigedienas-ns.90526.aspx.html"/></xsl:variable>
