...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra/aarjelsaemien-giele/risten-no.aspx'"/>
	...
	<parallel_text xml:lang="sme" location="risten-no-ns.90549.aspx.html"/></xsl:variable>
