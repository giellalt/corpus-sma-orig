...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'lierehtimmie.doc'"/>
  <xsl:variable name="title" select="'Saemesth amma - Lierehtimmie 2'"/>
  ...
  <xsl:variable name="place" select="'Sijti Jarnge'"/>
