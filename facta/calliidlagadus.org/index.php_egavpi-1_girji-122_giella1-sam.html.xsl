...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/web/index.php?egavpi=1&amp;girji=122&amp;giella1=sam'"/>
	...
	<parallel_text xml:lang="smj" location="index.php_egavpi-1_girji-117_giella1-sam.html"/></xsl:variable>
