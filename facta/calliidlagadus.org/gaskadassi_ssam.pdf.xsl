...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/govat/doc/gaskadassi_ssam.pdf'"/>
    ...
    <parallel_text xml:lang="sme" location="gaskadassi_nsam.pdf"/></xsl:variable>
