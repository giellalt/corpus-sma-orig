...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Bildtexter_sarvslakt.doc'"/>
  <xsl:variable name="title" select="'Sarvslakt bildtexter'"/>
  <xsl:variable name="author1_fn" select="'Anneli'"/>
  <xsl:variable name="author1_ln" select="'Kråik'"/>
  ...
  <xsl:variable name="author3_fn" select="'David'"/>
  <xsl:variable name="author3_ln" select="'Jonasson'"/>
  ...
  <xsl:variable name="publisher" select="'Anneli Kråik'"/>
  <xsl:variable name="publChannel" select="''"/>
  <xsl:variable name="year" select="'2008'"/>
  <xsl:variable name="ISBN" select="''"/>
  <xsl:variable name="ISSN" select="''"/>
  <xsl:variable name="place" select="'Sáminuorat'"/>
