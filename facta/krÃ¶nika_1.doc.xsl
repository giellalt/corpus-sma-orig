...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'krönika_1.doc'"/>
  <xsl:variable name="title" select="'krönika.doc'"/>
  <xsl:variable name="author1_fn" select="'David Jonasson'"/>
  <xsl:variable name="author1_ln" select="'JJ &amp; Borga'"/>
  ...
  <xsl:variable name="publisher" select="'Saemiedigkie SE'"/>
