...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.gaaltije.se/sm/saemien-turismeoevtiedimmie.html'"/>
    ...
    <parallel_text xml:lang="swe" location="samisk-turism.html"/></xsl:variable>
