...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'sydsamiska.pdf'"/>
  <xsl:variable name="title" select="'sydsamiska.indd'"/>
  <xsl:variable name="author1_fn" select="'Utbildnings och kulturdepartementet'"/>
  ...
  <xsl:variable name="place" select="'Regeringskansliet'"/>
