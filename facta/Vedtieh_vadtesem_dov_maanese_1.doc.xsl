...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Vedtieh_vadtesem_dov_maanese_1.doc'"/>
  <xsl:variable name="title" select="'Vedtieh vadtesem dov maanese: Ge ditt barn en gåva'"/>
  <xsl:variable name="author1_fn" select="'Leena'"/>
  <xsl:variable name="author1_ln" select="'Huss'"/>
