...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Från_infonuorra.doc'"/>
  <xsl:variable name="title" select="'från infonuorra'"/>
  ...
  <xsl:variable name="year" select="'2003-2008'"/>
  <xsl:variable name="ISBN" select="''"/>
  <xsl:variable name="ISSN" select="''"/>
  <xsl:variable name="place" select="'Infornuorra'"/>
