...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Ohtsedäjjah.doc'"/>
  <xsl:variable name="title" select="'Ohtsedäjjah'"/>
  <xsl:variable name="author1_fn" select="'David'"/>
  <xsl:variable name="author1_ln" select="' Jonasson'"/>
