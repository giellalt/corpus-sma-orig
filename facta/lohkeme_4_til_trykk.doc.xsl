...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'lohkeme_4_til_trykk.doc'"/>
  <xsl:variable name="title" select="'Saemesth amma - Njieljede gärja'"/>
  <xsl:variable name="author1_fn" select="'Helen'"/>
  <xsl:variable name="author1_ln" select="'B. Brandsfjell'"/>
  <xsl:variable name="author1_gender" select="'f'"/>
  <xsl:variable name="author1_born" select="''"/>
  <xsl:variable name="author1_nat" select="''"/>
  <xsl:variable name="author2_fn" select="'Asta'"/>
  <xsl:variable name="author2_ln" select="'Vangberg'"/>
  ...
  <xsl:variable name="publisher" select="'Sijti Jarnge'"/>
