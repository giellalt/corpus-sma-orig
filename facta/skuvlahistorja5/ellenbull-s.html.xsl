...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/ellenbull-s.htm'"/>
    ...
    <xsl:variable name="translator_fn" select="'Ellen Bull'"/>
    <xsl:variable name="translator_ln" select="'Jonassen'"/>
    <xsl:variable name="translator_gender" select="'f'"/>
    <xsl:variable name="translator_born" select="'1958'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="ellenbull-n.html"/>
