...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samisk.no/attachments/141_Hefte_M%C3%AFerhkh_281011.pdf'"/>
    ...
    <xsl:variable name="note" select="'http://www.aajege.no/attachments/141_Hefte_M%C3%AFerhkh_281011.pdf'"/>
