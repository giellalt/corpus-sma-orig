...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samisk.no/attachments/130_Tjaalege_voessem%20tsagkedh.pdf'"/>
    ...
    <xsl:variable name="note" select="'http://www.aajege.no/attachments/130_Tjaalege_voessem%20tsagkedh.pdf'"/>
