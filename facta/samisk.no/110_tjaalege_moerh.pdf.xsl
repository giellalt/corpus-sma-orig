...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samisk.no/attachments/110_Tjaalege_Moerh.pdf'"/>
    ...
    <xsl:variable name="note" select="'http://www.aajege.no/attachments/110_Tjaalege_Moerh.pdf'"/>
