...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samisk.no/attachments/127_Info%20om%20prosjektet%20%C3%85ar.pdf'"/>
    ...
    <xsl:variable name="note" select="'http://www.aajege.no/attachments/127_Info%20om%20prosjektet%20%C3%85ar.pdf'"/>
