...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://gielemnastedh.no/2013/08/gieleviermie-2013'"/>
    ...
    <parallel_text xml:lang="swe" location="ga-eleviermie-2013-information.pdf"/></xsl:variable>
