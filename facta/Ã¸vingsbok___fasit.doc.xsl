...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'øvingsbok___fasit.doc'"/>
  <xsl:variable name="title" select="'Saemesth amma - Lierehtimmie 1'"/>
  ...
  <xsl:variable name="author2_fn" select="'Åsta Vangberg '"/>
