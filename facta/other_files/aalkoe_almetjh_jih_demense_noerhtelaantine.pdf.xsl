...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.diva-portal.se/smash/get/diva2:1421891/FULLTEXT01.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Aalkoe-almetjh jïh demense Noerhtelaantine'"/>
    <!--
    ...
    <xsl:variable name="bottom_margin" select="'8=16, 9=27, 10=17, 11=12, 12=14, 14=15, 15=16, 16=39, 21=15'"/>
