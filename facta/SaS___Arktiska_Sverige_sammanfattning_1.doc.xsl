...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'SaS___Arktiska_Sverige_sammanfattning_1.doc'"/>
  <xsl:variable name="title" select="'Sammanfattning'"/>
  <xsl:variable name="author1_fn" select="''"/>
  <xsl:variable name="author1_ln" select="'Sofia Rickberg'"/>
  ...
  <xsl:variable name="place" select="'Sametinget SE'"/>
  <xsl:variable name="genre" select="'facta'"/>
  <xsl:variable name="collection" select="''"/>
  <xsl:variable name="translator_fn" select="'Per-Martin'"/>
  <xsl:variable name="translator_ln" select="'Israelsson'"/>
