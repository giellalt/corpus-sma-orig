...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'14-1999.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sijhtem åarjel-saemien gielem lieredh'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Dagfinn'"/>
    <xsl:variable name="author1_ln" select="'Vold'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="translator_fn" select="'Ella'"/>
    <xsl:variable name="translator_ln" select="'Holm Bull'"/>
    <xsl:variable name="translator_gender" select="'f'"/>
    <xsl:variable name="translator_born" select="'1929'"/>
