...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'saemesth_amma__1.doc'"/>
  <xsl:variable name="title" select="'Saemesth amma, voestes gärja'"/>
  <xsl:variable name="author1_fn" select="''"/>
  <xsl:variable name="author1_ln" select="'Helen Blind Brandsfjell'"/>
