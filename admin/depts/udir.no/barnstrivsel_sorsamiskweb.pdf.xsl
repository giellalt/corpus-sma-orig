...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/barnehage/pedagogikk/veiledere/barnstrivsel_sorsamiskweb.pdf'"/>
    ...
    <parallel_text xml:lang="sme" location="barnstrivsel_nordsamiskweb.pdf"/></xsl:variable>
