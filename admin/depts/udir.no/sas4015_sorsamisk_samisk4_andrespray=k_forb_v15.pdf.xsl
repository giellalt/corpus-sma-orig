...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/Filer/Vurdering/Eksamen-VGO/Forberedelse/V15/SAS4015_Sorsamisk_Samisk4_andrespråk_forb_V15.pdf'"/>
    ...
    <language xml:lang="sma"/><language xml:lang="nno"/><language xml:lang="nob"/></xsl:variable>
