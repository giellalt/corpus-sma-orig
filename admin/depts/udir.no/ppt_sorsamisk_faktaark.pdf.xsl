...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/pp_tjenesten/ppt_sorsamisk_faktaark.pdf'"/>
    ...
    <parallel_text xml:lang="smj" location="ppt_lulesamisk_faktaark.pdf"/></xsl:variable>
