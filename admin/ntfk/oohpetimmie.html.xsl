...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/Aarjelsaemien/Oohpehtimmie/Sider/default.aspx'"/>
    ...
    <parallel_text xml:lang="nob" location="oohpetimmie.html"/></xsl:variable>
