...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/Aarjelsaemien/Documents/Politisk%20plattform%20-%20s%C3%B8rsamisk.pdf'"/>
    ...
    <parallel_text xml:lang="nob" location="politisk_plattform_endelig_versjon_ap-h-krf.pdf"/></xsl:variable>
