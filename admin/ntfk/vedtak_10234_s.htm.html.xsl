...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/bibliotek/saker/2010/FR/Vedtak%2010234_s.htm'"/>
    ...
    <parallel_text xml:lang="nob" location="vedtak10234.htm.html"/></xsl:variable>
