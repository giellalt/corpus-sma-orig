...
<xsl:variable name="filename" select="'http://www.udir.no/upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/Samiske/Samisk_som_andresprak_sorsamisk.rtf'"/>
<xsl:variable name="title" select="'SAEMIEN MUBPIEGÏELINE, SAEMIEN 2 JÏH SAEMIEN 3 - LEAROESOEJKESJE'"/>
...
<xsl:variable name="wordcount" select="'3220'"/>
