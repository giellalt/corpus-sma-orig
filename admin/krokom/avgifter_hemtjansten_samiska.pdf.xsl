...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.krokom.se/download/18.2a47df6b1535a499ca551c2d/1479115511324/Avgifter_hemtjansten_samiska.pdf'"/>
    ...
    <xsl:variable name="bottom_margin" select="'4=20'"/>
