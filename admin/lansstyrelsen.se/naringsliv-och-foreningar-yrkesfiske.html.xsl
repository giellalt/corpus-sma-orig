...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/dalarna/SMA/naringsliv-och-foreningar/yrkesfiske/Pages/default.aspx'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	<parallel_text xml:lang="eng" location="naringsliv-och-foreningar-yrkesfiske.html"/>
</xsl:variable>
