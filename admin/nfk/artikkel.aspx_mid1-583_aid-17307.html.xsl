...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arkivinordland.no/artikkel.aspx?MId1=583&amp;AId=17307'"/>
    ...
    <parallel_text xml:lang="nob" location="nytt-seminar-om-nordlands-historie.aspx.html"/></xsl:variable>
