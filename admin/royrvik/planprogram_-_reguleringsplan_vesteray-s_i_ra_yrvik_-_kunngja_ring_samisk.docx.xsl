...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/CE056F37129005FAC1257B860043624D/$FILE/Planprogram+-+reguleringsplan+Vester%C3%A5s+i+R%C3%B8yrvik+-+kunngj%C3%B8ring+samisk.docx'"/>
	...
	<parallel_text xml:lang="nob" location="planprogram_-_reguleringsplan_vesteray-s_i_ra_yrvik.pdf"/></xsl:variable>
