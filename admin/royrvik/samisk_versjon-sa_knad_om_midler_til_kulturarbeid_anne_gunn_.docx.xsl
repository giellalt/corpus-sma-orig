...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/2D99CE8C876C74C2C1257CA8004B5458/$FILE/Samisk+versjon-S%C3%B8knad+om+midler+til+kulturarbeid+(Anne+Gunn).docx'"/>
    ...
    <parallel_text xml:lang="nob" location="saknad_om_statte_til_kulturarbeid_2014.docx"/></xsl:variable>
