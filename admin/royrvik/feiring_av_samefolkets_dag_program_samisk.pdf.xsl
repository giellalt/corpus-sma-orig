...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/4B87532D17A4D2C0C1257C74002C5F0A/$FILE/Feiring+av+samefolkets+dag+Program+samisk.pdf'"/>
    ...
    <parallel_text xml:lang="nob" location="feiring_av_samefolkets_dag_program.pdf"/></xsl:variable>
