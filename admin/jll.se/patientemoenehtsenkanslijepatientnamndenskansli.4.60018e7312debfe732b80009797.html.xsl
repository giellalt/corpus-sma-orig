...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://jll.se/omoss/informationpaandrasprak/aarjelsaemiesame/patientemoenehtsenkanslijepatientnamndenskansli.4.60018e7312debfe732b80009797.html'"/>
    ...
    <parallel_text xml:lang="fin" location="potilaslautakunnankansliapatientnamndenskansli.4.603682d013ae38e6d09c7.html"/></xsl:variable>
