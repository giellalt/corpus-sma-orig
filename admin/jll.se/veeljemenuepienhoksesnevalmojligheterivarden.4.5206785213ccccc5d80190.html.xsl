...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://jll.se/omoss/informationpaandrasprak/aarjelsaemiesame/veeljemenuepienhoksesnevalmojligheterivarden.4.5206785213ccccc5d80190.html'"/>
    ...
    <parallel_text xml:lang="fin" location="hoidonvalinnanmahdollisuudetvalmojligheterivarden.4.5206785213ccccc5d8027e.html"/></xsl:variable>
