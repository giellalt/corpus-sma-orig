...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'PRM_-_Støttemateriell-videoer_til_lule-_og_sørsamiske_fag - sma- oversettelse.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm_-_stottemateriell-videoer_til_lule-_og_sorsamiske_fag-_nob_opprinnelig.docx"/>
