...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/en-halv-million-til-sprakutvikling-bade-i-skole-og-barnehage-pa-roros.22779.aspx?sprak=14'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bielie millijovne gïeleevtiedæmman dovne skuvlesne jïh maanagïertesne Plaassjesne - Saemiedigkie'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="en_halv_million_til_sprakutvikling_bade_i_skole_og_barnehage_pa_roros.html"/>
