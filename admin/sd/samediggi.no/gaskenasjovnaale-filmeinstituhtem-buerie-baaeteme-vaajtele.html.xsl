...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/layout/set/print/Kultuvrejieleme/Meedijah/Gaskenasjovnaale-filmeinstituhtem-buerie-baaeteme-vaajtele'"/>
	...
	<parallel_text xml:lang="sme" location="savva-riikkaidgaskasas-sami-filbmainstituhttii-bures-boahtima.html"/></xsl:variable>
