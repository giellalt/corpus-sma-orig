...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/layout/set/print/Oahpahus/Dutkan-ja-alit-oahpahus/Stipeanda-ja-doarjja'"/>
    ...
    <parallel_text location="stipeanda-ja-doarjja.html" xml:lang="sme"/>
<parallel_text location="stipend-og-tilskudd.html" xml:lang="nob"/>
</xsl:variable>
