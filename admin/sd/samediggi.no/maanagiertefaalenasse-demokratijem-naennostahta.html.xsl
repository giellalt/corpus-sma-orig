...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/layout/set/print/Saemiedigkien-bijre/AAaarganisasjovnestruktuvre/Saemiedigkieraerie/Haaalemh-jih-tjaalegh/Maanagiertefaalenasse-demokratijem-naennostahta'"/>
	...
	<parallel_text xml:lang="sme" location="kronihkka-sami-manaidgardefaldat-nanne-demokratija.html"/></xsl:variable>
