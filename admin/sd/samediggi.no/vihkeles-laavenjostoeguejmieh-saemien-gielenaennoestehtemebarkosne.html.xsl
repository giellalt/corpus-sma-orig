...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/layout/set/print/Giele/Reeremedajve-saemien-gielide/Vihkeles-laavenjostoeguejmieh-saemien-gielenaennoestehtemebarkosne'"/>
	...
	<parallel_text xml:lang="sme" location="dehalas-ovttasbargoguoimmut-samegiela-nannemis.html"/></xsl:variable>
