...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/layout/set/print/Jielemh/Marijne-jielemh/Aalkoealmetjegiele-tjuara-govlelgidh-reeremisnie-eatnemeloeseste'"/>
	...
	<parallel_text xml:lang="sme" location="algoalbmotjietna-ferte-gullot-luondduluosa-halddaseamis.html"/></xsl:variable>
