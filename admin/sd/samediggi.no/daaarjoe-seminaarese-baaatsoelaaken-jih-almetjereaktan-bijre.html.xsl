...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/layout/set/print/Jielemh/Baaatsoe/Daaarjoe-seminaarese-Baaatsoelaaken-jih-almetjereaktan-bijre'"/>
	...
	<parallel_text xml:lang="sme" location="doarjja-seminarii-boazodoalolaga-ja-albmotrievtti-birra.html"/></xsl:variable>
