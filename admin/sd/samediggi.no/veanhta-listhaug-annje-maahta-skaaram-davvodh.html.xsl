...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.saemiedigkie.no/layout/set/print/Jielemh/Baaatsoe/Veanhta-Listhaug-annje-maahta-skaaram-davvodh'"/>
	...
	<parallel_text xml:lang="sme" location="oaivvilda-ahte-listhaug-ain-sahtta-njulget-boasttuvuoda.html"/></xsl:variable>
