...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Översättning_Sametinget_jan08.doc'"/>
  <xsl:variable name="title" select="'Översättning Sametinget_jan08'"/>
  <xsl:variable name="author1_fn" select="'Marie'"/>
  <xsl:variable name="author1_ln" select="'Enoksson'"/>
