...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sjugniedihks jieleme – akte ovnuhteme nuepie saemiedigkieraerien dahkoesoejkesje kultuvrelle- jïh sjugniedihks jieliemasse'"/>
    <!--
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'13=5'"/>
    <xsl:variable name="inner_left_margin" select="'13=5'"/>
    <xsl:variable name="inner_top_margin" select="'13=10'"/>
    <xsl:variable name="inner_bottom_margin" select="'13=73'"/>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'kul-tuvre/Ameri-jhkeste/vi-hkielommes/kultuvre-jieliemidie/dahkoe-soejkesje/duedtievytnes-jæjjide/kultuvreråa-jvarimmide/næn-noes/aavenjos-toe/«tjeah-poen/bieli-etïjjen/sjugniedi-hks/mi-jjieh/Seamma-laakan/sjugnie-dihks/kultuvrejiel-emesuerkien/Juk-tie/Jïjtje-hke/öörne-gidie/maarhkedegoerehtim-mieh/Åestijegoerehtim-mieh/maarhk-edevåaromen/ekonome-les/'"/>
                <xsl:with-param name="replacement" select="'kultuvre/Amerijhkeste/vihkielommes/kultuvrejieliemidie/dahkoesoejkesje/duedtievytnesjæjjide/kultuvreråajvarimmide/nænnoes/aavenjostoe/«tjeahpoen/bielietïjjen/sjugniedihks/mijjieh/Seammalaakan/sjugniedihks/kultuvrejielemesuerkien/Juktie/Jïjtjehke/öörnegidie/maarhkedegoerehtimmieh/Åestijegoerehtimmieh/maarhkedevåaromen/ekonomeles/'"/>
                <xsl:with-param name="continue" select="0"/>
            </xsl:call-template>
        </xsl:element>
    </xsl:template>
