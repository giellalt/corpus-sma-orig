...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'ojs.novus.no/index.php/DIN/article/download/1511/1495'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dåajmijes vuekie lea saemien vuekie'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Lena'"/>
    <xsl:variable name="author1_ln" select="'Kappfjell'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Harald'"/>
    <xsl:variable name="author2_ln" select="'Gaski'"/>
    <xsl:variable name="author2_gender" select="'m'"/>
    <xsl:variable name="author2_nat" select="'NO'"/>
    <xsl:variable name="author2_born" select="'1955'"/>
    ...
    <xsl:variable name="bottom_margin" select="'2=16, 4=18'"/>
