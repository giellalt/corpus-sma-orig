...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kap_5.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saemien lohkehtæjjaveahka'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'10-11, 14-15, 21'"/>
    ...
    <xsl:variable name="top_margin" select="'6=40, 12=40, 16=22'"/>
    <xsl:variable name="bottom_margin" select="'2=13, 4=12, 5=50, 6=18, 7=18, 13=20, 16=18, 17=18, 18=12'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'8=33, 9=18'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=25, 9=50'"/>
