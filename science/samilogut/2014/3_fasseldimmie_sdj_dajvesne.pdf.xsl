...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/3.sysselsetting_i_stn-omr.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fasseldimmie SDJ-dajvesne'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Gunnar'"/>
    <xsl:variable name="author1_ln" select="'Claus'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_sysselsetting_i_stn.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'3=43, 5=57, 7=41, 9=50'"/>
    <xsl:variable name="bottom_margin" select="'2=43, 3=36'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'6=20'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=48'"/>
