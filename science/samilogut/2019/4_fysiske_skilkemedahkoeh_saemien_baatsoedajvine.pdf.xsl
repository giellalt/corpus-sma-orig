...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4_fysiske_inngrep_i_samiske_rein.-_sorsamisk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fysiske skilkemedahkoeh saemien båatsoedajvine: Aerviedimmie tsevtsemedajvijste'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4_fysiske_inngrep_i_samiske_reinbeiteomraader.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'16-17, 21, 26-27'"/>
    ...
    <xsl:variable name="top_margin" select="'all=4, 13=45, 14=45, 20=45'"/>
    <xsl:variable name="bottom_margin" select="'3=18, 8=18, 12=60, 20=18, 22=16, 23=15, 25=50'"/>
