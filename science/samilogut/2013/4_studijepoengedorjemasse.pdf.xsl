...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4.studiepoengproduksjon_i_samisk_21._aug_-_sarsamisk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Studijepoengedorjemasse saemien jollebe ööhpehtimmesne'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4_studiepoengproduksjon.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'11, 18'"/>
    ...
    <xsl:variable name="top_margin" select="'6=29, 8=28, 13=22'"/>
    <xsl:variable name="bottom_margin" select="'3=20, 4=20, 5=17, 7=40, 9=53, 12=20, 13=13, 15=16, 16=18'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'2=7, 7=7, 8=7, 13=7, 14=7'"/>
    <xsl:variable name="inner_left_margin" select="'2=7, 7=7, 8=7, 13=7, 14=7'"/>
    <xsl:variable name="inner_top_margin" select="'2=20, 7=32, 8=46, 13=40, 14=32'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=60, 7=58, 8=40, 13=49, 14=50'"/>
