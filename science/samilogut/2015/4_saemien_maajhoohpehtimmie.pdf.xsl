...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4.saemien_maajhoohpehtimmiefinal.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saemien maajhööhpehtimmie'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4_samisk_fjernundervisning.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'7, 9-10'"/>
    ...
    <xsl:variable name="top_margin" select="'4=47, 7=38, 8=65, 11=72'"/>
    <xsl:variable name="bottom_margin" select="'2=20, 3=33, 4=13, 5=12, 6=18, 7=20, 8=18, 11=13, 12=48'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'5=7, 11=7'"/>
    <xsl:variable name="inner_left_margin" select="'5=7, 11=7'"/>
    <xsl:variable name="inner_top_margin" select="'5=59, 11=14'"/>
    <xsl:variable name="inner_bottom_margin" select="'5=18, 11=28'"/>
