...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="4_helserelaterte_leve_og_arbeidsforhold.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'11, 29-32'"/>
    ...
    <xsl:variable name="top_margin" select="'7=67, 13=45, 16=58, 19=49, 20=33, 24=50'"/>
    <xsl:variable name="bottom_margin" select="'all=11, 3=15, 5=20, 9=18, 20=7, 21=7, 22=56, 23=20, 24=7, 16=9'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'9=7, 14=7, 15=7, 17=7, 21=7, 25=7'"/>
    <xsl:variable name="inner_left_margin" select="'9=7, 14=7, 15=7, 17=7, 21=7, 25=7'"/>
    <xsl:variable name="inner_top_margin" select="'9=38, 14=27, 15=40, 17=23, 21=16, 25=19'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=32, 14=36, 15=34, 17=23, 21=50, 25=47'"/>
