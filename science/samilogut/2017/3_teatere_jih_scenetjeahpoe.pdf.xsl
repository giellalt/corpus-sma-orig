...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Ada Einmo'"/>
    <xsl:variable name="author1_ln" select="'Jürgensen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'19510615'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="3_teater_og_scenekunst.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'7-8, 17-18, 29'"/>
    ...
    <xsl:variable name="top_margin" select="'1=22, 9=80, 12=34, 19=55'"/>
    <xsl:variable name="bottom_margin" select="'3=16, 6=77, 14=12, 15=13, 16=55, 20=55, 22=12, 25=13'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'11=21'"/>
    <xsl:variable name="inner_bottom_margin" select="'11=55'"/>
