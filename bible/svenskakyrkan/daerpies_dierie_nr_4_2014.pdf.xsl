...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://internwww.svenskakyrkan.se/default.aspx?id=850505&amp;ptid=3095'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Daerpies Dierie - Sydsamiskt kyrkoblad nr. 4, 2014'"/>
    <!--
    ...
    <language xml:lang="sma"/><language xml:lang="swe"/><language xml:lang="nob"/></xsl:variable>
