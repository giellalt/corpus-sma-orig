...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Sydsamiska_Sanna_redY_1_.doc'"/>
  <xsl:variable name="title" select="'Sanna'"/>
  <xsl:variable name="author1_fn" select="'Sara'"/>
  <xsl:variable name="author1_ln" select="' Aira Fjällström'"/>
  ...
  <xsl:variable name="author3_nat" select="'swe'"/>
  ...
  <xsl:variable name="publisher" select="'Sameskolstyrelsen'"/>
  <xsl:variable name="publChannel" select="''"/>
  <xsl:variable name="year" select="'2007'"/>
  <xsl:variable name="ISBN" select="''"/>
  <xsl:variable name="ISSN" select="''"/>
  <xsl:variable name="place" select="'LL-förlaget, SamS'"/>
  <xsl:variable name="genre" select="'ficti'"/>
  <xsl:variable name="collection" select="''"/>
  <xsl:variable name="translator_fn" select="'Sakka'"/>
  <xsl:variable name="translator_ln" select="'Nejne'"/>
