...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Voernesen_g__�_jrejuhteme.doc'"/>
  <xsl:variable name="title" select="'Voernese gïjrejuhteme'"/>
  <xsl:variable name="author1_fn" select="'Lena'"/>
  <xsl:variable name="author1_ln" select="'Kroik'"/>
